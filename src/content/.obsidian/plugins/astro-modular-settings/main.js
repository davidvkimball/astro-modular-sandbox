...
var E=Object.defineProperty;var D=Object.getOwnPropertyDescriptor;var N=Object.getOwnPropertyNames;var H=Object.prototype.hasOwnProperty;var j=(g,n)=>{for(var e in n)E(g,e,{get:n[e],enumerable:!0})},B=(g,n,e,t)=>{if(n&&typeof n=="object"||typeof n=="function")for(let a of N(n))!H.call(g,a)&&a!==e&&E(g,a,{get:()=>n[a],enumerable:!(t=D(n,a))||t.enumerable});return g};var q=g=>B(E({},"__esModule",{value:!0}),g);var R={};j(R,{default:()=>k});module.exports=q(R);var L=require("obsidian");var M=["Inter","Roboto","Open Sans","Lato","Poppins","Source Sans Pro","Nunito","Montserrat","Playfair Display","Merriweather","Lora","Crimson Text","PT Serif","Libre Baskerville","Fira Code","JetBrains Mono","Source Code Pro","IBM Plex Mono","Cascadia Code"],I={runWizardOnStartup:!0,currentTemplate:"standard",currentTheme:"oxygen",contentOrganization:"file-based",features:{commandPalette:!0,tableOfContents:!0,readingTime:!0,linkedMentions:!0,comments:!1,graphView:!0,postNavigation:!0,scrollToTop:!0,darkModeToggleButton:"both",showSocialIconsInFooter:!0,showPostCardCoverImages:"featured-and-posts",postCardAspectRatio:"og",linkedMentionsCompact:!1},typography:{headingFont:"Inter",proseFont:"Inter",monoFont:"JetBrains Mono",fontSource:"local",customFonts:{heading:"",prose:"",mono:""}},optionalFeatures:{profilePicture:{enabled:!1,image:"/profile.jpg",alt:"Profile picture",size:"md",placement:"footer",style:"circle"},comments:{enabled:!1,provider:"giscus"}},deployment:{platform:"netlify"},pluginConfig:{obsidianSettings:{attachmentLocation:"subfolder",subfolderName:"attachments"},astroComposerSettings:{creationMode:"file-based",indexFileName:"index"},imageInserterSettings:{insertFormat:"[[attachments/{image-url}]]"}}},S=[{id:"oxygen",name:"Oxygen",description:"Modern, clean design",previewColors:["#0ea5e9","#0284c7","#f8fafc"]},{id:"minimal",name:"Minimal",description:"Understated with high contrast",previewColors:["#708794","#5a6d77","#fafafa"]},{id:"atom",name:"Atom",description:"Dark theme with vibrant accents",previewColors:["#61dafb","#1a92ff","#282c34"]},{id:"ayu-light",name:"Ayu Light",description:"Clean light theme",previewColors:["#ffcc66","#e6913d","#fefefe"]},{id:"ayu-mirage",name:"Ayu Mirage",description:"Soft dark theme",previewColors:["#ffcc66","#e6913d","#1f2430"]},{id:"ayu-dark",name:"Ayu Dark",description:"Deep dark theme",previewColors:["#ffcc66","#e6913d","#0f1419"]},{id:"catppuccin",name:"Catppuccin",description:"Pastel color palette",previewColors:["#dcb6af","#c49a8f","#1e1e2e"]},{id:"charcoal",name:"Charcoal",description:"Dark, professional look",previewColors:["#ffffff","#ff6b6b","#2d2d2d"]},{id:"dracula",name:"Dracula",description:"Dark theme with purple accents",previewColors:["#bd93f9","#8b5cf6","#282a36"]},{id:"everforest",name:"Everforest",description:"Soft, warm colors",previewColors:["#a7c080","#dbbc7f","#2d353b"]},{id:"flexoki",name:"Flexoki",description:"Based on Material Design 3",previewColors:["#ff6b6b","#e6b673","#100f0f"]},{id:"gruvbox",name:"Gruvbox",description:"Retro groove color scheme",previewColors:["#fabd2f","#b16286","#282828"]},{id:"macos",name:"macOS",description:"Native macOS appearance",previewColors:["#007aff","#34c759","#ffffff"]},{id:"nord",name:"Nord",description:"Arctic-inspired color palette",previewColors:["#88c0d0","#a3be8c","#2e3440"]},{id:"obsidian",name:"Obsidian",description:"Matches Obsidian's default theme",previewColors:["#7c3aed","#ffffff","#1e1e1e"]},{id:"rose-pine",name:"Ros\xE9 Pine",description:"All natural pine, faux fir, and winter",previewColors:["#eb6f92","#9ccfd8","#191724"]},{id:"sky",name:"Sky",description:"Light, airy design",previewColors:["#0ea5e9","#06b6d4","#f0f9ff"]},{id:"solarized",name:"Solarized",description:"Precision colors for machines and people",previewColors:["#268bd2","#859900","#002b36"]},{id:"things",name:"Things",description:"Clean, minimal design",previewColors:["#007aff","#000000","#ffffff"]}],C=[{id:"standard",name:"Standard",description:"Full-featured blog with all default options enabled",features:["Command palette","Table of contents","Reading time","Linked mentions","Footer","Social icons","Scroll to top","Dark mode toggle"],recommended:!0},{id:"compact",name:"Compact",description:"Balanced setup for smaller sites with optimized layout",features:["Command palette","Table of contents","Reading time","Compact linked mentions","Custom aspect ratio"],recommended:!1},{id:"minimal",name:"Minimal",description:"Clean, simple blog with minimal features and content",features:["Command palette","Search posts/pages","Minimal navigation"],recommended:!1},{id:"custom",name:"Custom",description:"Granular control over every setting - opens config.ts",features:["All features configurable"],recommended:!1}];var x=require("obsidian");var T=require("obsidian");var w=class{constructor(n){this.app=n,this.configPath="../config.ts",console.log("\u{1F4C1} Config path:",this.configPath)}async getConfigFileInfo(){console.log("\u{1F50D} Looking for config at:",this.configPath),console.log("\u{1F3E0} Vault root path:",this.app.vault.adapter.path);try{let n=require("fs"),e=require("path"),t=this.app.vault.adapter.basePath||this.app.vault.adapter.path;console.log("\u{1F3E0} Vault path object:",t),console.log("\u{1F3E0} Vault path type:",typeof t);let a=typeof t=="string"?t:t.toString();console.log("\u{1F3E0} Vault path string:",a);let i=e.join(a,"..","config.ts");if(console.log("\u{1F50D} Trying to read config from:",i),n.existsSync(i)){console.log("\u2705 Found config file outside vault at:",i);let r=n.readFileSync(i,"utf8"),l=n.statSync(i);return{exists:!0,path:i,content:r,lastModified:new Date(l.mtime),valid:!0,errors:[]}}else return console.log("\u274C Config file not found at:",i),{exists:!1,path:i,content:"",lastModified:new Date,valid:!1,errors:["Config file not found"]}}catch(n){return console.log("\u274C Error accessing file outside vault:",n.message),{exists:!1,path:this.configPath,content:"",lastModified:new Date,valid:!1,errors:["Cannot access file outside vault"]}}}validateConfigContent(n){return n.includes("defineConfig")||n.includes("export default")||n.includes("astro/config")}async readConfig(){return(await this.getConfigFileInfo()).content}async writeConfig(n){console.log("\u{1F4DD} ConfigManager: Attempting to write config");try{let e=require("fs"),t=require("path"),a=this.app.vault.adapter.basePath||this.app.vault.adapter.path;console.log("\u{1F3E0} Vault path object:",a),console.log("\u{1F3E0} Vault path type:",typeof a);let i=typeof a=="string"?a:a.toString();console.log("\u{1F3E0} Vault path string:",i);let r=t.join(i,"..","config.ts");return console.log("\u{1F4C1} Writing config to:",r),e.writeFileSync(r,n,"utf8"),console.log("\u2705 Config file written successfully"),!0}catch(e){return console.log("\u274C Error writing config file:",e.message),!1}}async applyPreset(n){console.log("\u{1F527} ConfigManager: Starting preset application"),console.log("\u{1F4CB} Preset:",n.name),console.log("\u2699\uFE0F Settings:",n.config);let e=await this.readConfig();console.log("\u{1F4D6} Current config length:",e.length),console.log("\u{1F4D6} Current config preview:",e.substring(0,200)+"...");let t=this.modifyConfigFromPreset(n,e);console.log("\u{1F195} Modified config length:",t.length),console.log("\u{1F195} Modified config preview:",t.substring(0,200)+"...");let a=await this.writeConfig(t);return console.log("\u{1F4BE} Write result:",a),a}modifyConfigFromPreset(n,e){var b,F,O;let t=n.config;console.log("\u{1F504} ConfigManager: Modifying existing config from preset"),console.log("\u{1F3A8} Theme:",t.currentTheme),console.log("\u{1F524} Fonts:",t.typography),console.log("\u{1F50D} Current config contains style:",e.includes('style: "circle"')),console.log("\u{1F50D} Current config contains pages:",e.includes("pages: false"));let a=/search:\s*\{\s*posts:\s*(true|false),\s*pages:\s*(true|false),\s*projects:\s*(true|false),\s*docs:\s*(true|false),\s*\}/,i=/url:\s*"[^"]*",?\s*\/\/ Optional\s*,\s*placement:\s*"[^"]*",?\s*\/\/ "footer" or "header"\s*,\s*style:\s*"[^"]*",?\s*\/\/ "circle", "square", or "none"/;console.log("\u{1F50D} Search regex will match:",a.test(e)),console.log("\u{1F50D} Style regex will match:",i.test(e));let r=e.match(/style:\s*"[^"]*"/g);console.log("\u{1F50D} All style matches:",r);let l=e.match(/pages:\s*(true|false)/g);console.log("\u{1F50D} All pages matches:",l);let f=/style:\s*"[^"]*",?\s*\/\/ "circle", "square", or "none"/,u=/pages:\s*(true|false),/;console.log("\u{1F50D} Style regex test:",f.test(e)),console.log("\u{1F50D} Pages regex test:",u.test(e));let c=e.match(/placement:\s*"[^"]*",?\s*\/\/ "footer" or "header"\s*,\s*style:\s*"[^"]*",?\s*\/\/ "circle", "square", or "none"/);console.log("\u{1F50D} Style context match:",c);let d=e.match(/search:\s*\{\s*posts:\s*(true|false),\s*pages:\s*(true|false),\s*projects:\s*(true|false),\s*docs:\s*(true|false),\s*\}/);console.log("\u{1F50D} Pages context match:",d);let o=this.getTemplateConfig(n.name,t),s=e;if(s=s.replace(/theme:\s*"[^"]*",?\s*\/\/ Available themes:/,`theme: "${t.currentTheme}", // Available themes:`),s=s.replace(/source:\s*"[^"]*"/,`source: "${t.typography.fontSource}"`),s=s.replace(/body:\s*"[^"]*"/,`body: "${t.typography.fontSource==="cdn"?t.typography.customFonts.prose:t.typography.proseFont}"`),s=s.replace(/heading:\s*"[^"]*"/,`heading: "${t.typography.fontSource==="cdn"?t.typography.customFonts.heading:t.typography.headingFont}"`),s=s.replace(/mono:\s*"[^"]*"/,`mono: "${t.typography.fontSource==="cdn"?t.typography.customFonts.mono:t.typography.monoFont}"`),s=s.replace(/platform:\s*"[^"]*"/,`platform: "${t.deployment.platform}"`),(b=o.layout)!=null&&b.contentWidth&&(s=s.replace(/contentWidth:\s*"[^"]*"/,`contentWidth: "${o.layout.contentWidth}"`)),o.optionalContentTypes&&(o.optionalContentTypes.projects!==void 0&&(s=s.replace(/projects:\s*(true|false),?\s*\/\/ Enable projects section/,`projects: ${o.optionalContentTypes.projects}, // Enable projects section`)),o.optionalContentTypes.docs!==void 0&&(s=s.replace(/docs:\s*(true|false),?\s*\/\/ Enable documentation section/,`docs: ${o.optionalContentTypes.docs}, // Enable documentation section`))),o.darkModeToggleButton&&(s=s.replace(/darkModeToggleButton:\s*"[^"]*",?\s*\/\/ "navigation" \| "commandPalette" \| "both"/,`darkModeToggleButton: "${o.darkModeToggleButton}", // "navigation" | "commandPalette" | "both"`)),o.footer&&(o.footer.enabled!==void 0&&(s=s.replace(/footer:\s*\{\s*enabled:\s*(true|false),/,`footer: {
    ...
    }`;s=s.replace(/search:\s*\{\s*posts:\s*(true|false),\s*pages:\s*(true|false),\s*projects:\s*(true|false),\s*docs:\s*(true|false),\s*\}/,h)}o.commandPalette.sections&&Object.entries(o.commandPalette.sections).forEach(([h,m])=>{let y;h==="pages"?(y=/pages:\s*(true|false)(,\s*social:)/,s=s.replace(y,`pages: ${m}$2`)):h==="social"?(y=/social:\s*(true|false)(,\s*\})/,s=s.replace(y,`social: ${m}$2`)):h==="quickActions"&&(y=/quickActions:\s*(true|false)(,\s*pages:)/,s=s.replace(y,`quickActions: ${m}$2`))})}o.homeOptions&&(o.homeOptions.featuredPost&&(o.homeOptions.featuredPost.enabled!==void 0&&(s=s.replace(/enabled:\s*(true|false),?\s*\/\/ Show featured post on homepage/,`enabled: ${o.homeOptions.featuredPost.enabled}, // Show featured post on homepage`)),o.homeOptions.featuredPost.type&&(s=s.replace(/type:\s*"[^"]*",?\s*\/\/ "latest" or "featured"/,`type: "${o.homeOptions.featuredPost.type}", // "latest" or "featured"`))),o.homeOptions.recentPosts&&(o.homeOptions.recentPosts.enabled!==void 0&&(s=s.replace(/enabled:\s*(true|false),?\s*\/\/ Show recent posts on homepage/,`enabled: ${o.homeOptions.recentPosts.enabled}, // Show recent posts on homepage`)),o.homeOptions.recentPosts.count&&(s=s.replace(/count:\s*\d+,?\s*\/\/ Number of recent posts to show/,`count: ${o.homeOptions.recentPosts.count}, // Number of recent posts to show`))),o.homeOptions.projects&&(o.homeOptions.projects.enabled!==void 0&&(s=s.replace(/enabled:\s*(true|false),?\s*\/\/ Show featured projects on homepage/,`enabled: ${o.homeOptions.projects.enabled}, // Show featured projects on homepage`)),o.homeOptions.projects.count&&(s=s.replace(/count:\s*\d+,?\s*\/\/ Number of projects to show/,`count: ${o.homeOptions.projects.count}, // Number of projects to show`))),o.homeOptions.docs&&(o.homeOptions.docs.enabled!==void 0&&(s=s.replace(/enabled:\s*(true|false),?\s*\/\/ Show featured docs on homepage/,`enabled: ${o.homeOptions.docs.enabled}, // Show featured docs on homepage`)),o.homeOptions.docs.count&&(s=s.replace(/count:\s*\d+,?\s*\/\/ Number of docs to show/,`count: ${o.homeOptions.docs.count}, // Number of docs to show`))),(O=o.homeOptions.blurb)!=null&&O.placement&&(s=s.replace(/placement:\s*"[^"]*",?\s*\/\/ 'above' \(at the top\), 'below' \(after content\), or 'none' \(disabled\)/,`placement: "${o.homeOptions.blurb.placement}", // 'above' (at the top), 'below' (after content), or 'none' (disabled)`))),o.postOptions&&(o.postOptions.postsPerPage&&(s=s.replace(/postsPerPage:\s*\d+/,`postsPerPage: ${o.postOptions.postsPerPage}`)),["readingTime","wordCount","tableOfContents","tags","postNavigation"].forEach(m=>{if(o.postOptions[m]!==void 0){let y;m==="readingTime"?y=/readingTime:\s*(true|false),?\s*\/\/ Show estimated reading time/:m==="wordCount"?y=/wordCount:\s*(true|false),?\s*\/\/ Show word count/:m==="tableOfContents"?y=/tableOfContents:\s*(true|false),?\s*\/\/ Show table of contents/:m==="tags"?y=/tags:\s*(true|false),?\s*\/\/ Show tags/:m==="postNavigation"&&(y=/postNavigation:\s*(true|false),?\s*\/\/ Show post navigation/),y&&(s=s.replace(y,`${m}: ${o.postOptions[m]}, // Show ${m}`))}}),o.postOptions.linkedMentions&&(o.postOptions.linkedMentions.enabled!==void 0&&(s=s.replace(/enabled:\s*(true|false),?\s*\/\/ Enable linked mentions/,`enabled: ${o.postOptions.linkedMentions.enabled}, // Enable linked mentions`)),o.postOptions.linkedMentions.linkedMentionsCompact!==void 0&&(s=s.replace(/linkedMentionsCompact:\s*(true|false)/,`linkedMentionsCompact: ${o.postOptions.linkedMentions.linkedMentionsCompact}`))),o.postOptions.graphView&&(o.postOptions.graphView.enabled!==void 0&&(s=s.replace(/graphView:\s*\{\s*enabled:\s*(true|false),/,`graphView: {
    enabled: ${o.postOptions.graphView.enabled},`)),o.postOptions.graphView.showInSidebar!==void 0&&(s=s.replace(/graphView:\s*\{[\s\S]*?showInSidebar:\s*(true|false),/,m=>m.replace(/showInSidebar:\s*(true|false),/,`showInSidebar: ${o.postOptions.graphView.showInSidebar},`))),o.postOptions.graphView.showInCommandPalette!==void 0&&(s=s.replace(/graphView:\s*\{[\s\S]*?showInCommandPalette:\s*(true|false),/,m=>m.replace(/showInCommandPalette:\s*(true|false),/,`showInCommandPalette: ${o.postOptions.graphView.showInCommandPalette},`))),o.postOptions.graphView.maxNodes&&(s=s.replace(/graphView:\s*\{[\s\S]*?maxNodes:\s*\d+,/,m=>m.replace(/maxNodes:\s*\d+,/,`maxNodes: ${o.postOptions.graphView.maxNodes},`)))),o.postOptions.showPostCardCoverImages&&(s=s.replace(/showPostCardCoverImages:\s*"[^"]*",?\s*\/\/ "all" \| "featured" \| "home" \| "posts" \| "featured-and-posts" \| "none"/,`showPostCardCoverImages: "${o.postOptions.showPostCardCoverImages}", // "all" | "featured" | "home" | "posts" | "featured-and-posts" | "none"`)),o.postOptions.postCardAspectRatio&&(s=s.replace(/postCardAspectRatio:\s*"[^"]*",?\s*\/\/ "16:9" \| "4:3" \| "3:2" \| "og" \| "square" \| "golden" \| "custom"/,`postCardAspectRatio: "${o.postOptions.postCardAspectRatio}", // "16:9" | "4:3" | "3:2" | "og" | "square" | "golden" | "custom"`)),o.postOptions.customPostCardAspectRatio&&(s=s.replace(/customPostCardAspectRatio:\s*"[^"]*",?\s*\/\/ For custom aspect ratio/,`customPostCardAspectRatio: "${o.postOptions.customPostCardAspectRatio}", // For custom aspect ratio`))),t.optionalFeatures.profilePicture.enabled&&(s=s.replace(/profilePicture:\s*\{\s*enabled:\s*(true|false),?\s*\/\/ Profile picture/,`profilePicture: {
    enabled: ${t.optionalFeatures.profilePicture.enabled}, // Profile picture`),s=s.replace(/profilePicture:\s*\{[\s\S]*?image:\s*"[^"]*",?\s*\/\/ Path to your profile image/,h=>h.replace(/image:\s*"[^"]*",?\s*\/\/ Path to your profile image/,`image: "${t.optionalFeatures.profilePicture.image}", // Path to your profile image`)),s=s.replace(/profilePicture:\s*\{[\s\S]*?alt:\s*"[^"]*"/,h=>h.replace(/alt:\s*"[^"]*"/,`alt: "${t.optionalFeatures.profilePicture.alt}"`)),s=s.replace(/profilePicture:\s*\{[\s\S]*?size:\s*"[^"]*",?\s*\/\/ "sm" \(32px\), "md" \(48px\), or "lg" \(64px\)/,h=>h.replace(/size:\s*"[^"]*",?\s*\/\/ "sm" \(32px\), "md" \(48px\), or "lg" \(64px\)/,`size: "${t.optionalFeatures.profilePicture.size}", // "sm" (32px), "md" (48px), or "lg" (64px)`)),s=s.replace(/profilePicture:\s*\{[\s\S]*?url:\s*"[^"]*",?\s*\/\/ Optional\s*,\s*placement:\s*"[^"]*",?\s*\/\/ "footer" or "header"\s*,\s*style:\s*"[^"]*",?\s*\/\/ "circle", "square", or "none"/,h=>h.replace(/url:\s*"[^"]*",?\s*\/\/ Optional\s*,\s*placement:\s*"[^"]*",?\s*\/\/ "footer" or "header"\s*,\s*style:\s*"[^"]*",?\s*\/\/ "circle", "square", or "none"/,`url: "${t.optionalFeatures.profilePicture.url||""}", // Optional
...
\u2514\u2500\u2500 another-post/
    ...
    \u2514\u2500\u2500 image.jpg</code></pre>
		...
		`,e.querySelectorAll(".org-option").forEach(t=>{t.addEventListener("click",()=>{let a=t.getAttribute("data-org");a&&(this.selectedContentOrg=a,this.renderCurrentStep())})})}renderFontStep(e){var t,a,i,r,l,f,u;e.innerHTML=`
