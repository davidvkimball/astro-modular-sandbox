...
**Next Steps:**
- Read the [Obsidian Vault Guide](testing-vault-cms-guide.md) for detailed setup
...
4. **Read the vault guide** - [Obsidian Vault Guide](testing-vault-cms-guide.md)
...
- **Obsidian Vault Guide**: [Obsidian Vault Guide](testing-vault-cms-guide.md)
